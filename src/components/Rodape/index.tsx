  ...
  return (
    <footer className={styles.rodape__container}>
      <div className={styles.rodape__textos}>
        <p>© 2023 - Criado utilizando <a href='https://www.figma.com/file/85lALiVeWhxE8RNvxSaKBI/Meu-Portifolio?node-id=0%3A1&t=CU1WuYIPQCZE53lU-1' className={styles.texto__criado} target='_blank' rel="noreferrer" >Figma</a> e <a href='https://www.linkedin.com/in/gildair-moreira-420408241/' target='_blank' className={styles.texto__desenvolvido} rel="noreferrer">Desenvolvido</a> Por  Gildair</p>
      </div>
