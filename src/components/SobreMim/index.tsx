    ...
    <section className={styles.container} id='sobre'>
      ...
      <aside className={styles.container__right}>
        ...
        <div className={styles.container__botoes}>
          <Botao icon={<FiDownloadCloud className={styles.LogoDownload} />} text={t('Curriculo')} gradient='linear-gradient(236deg, rgba(26,35,44,1) 0%, rgba(0,215,255,1) 100%)' url="https://drive.google.com/file/d/1u9x4Pt1rkXDKezFhvxspZPRHETghHVs0/view?usp=sharing" />
