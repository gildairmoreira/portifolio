    ...
    <section className={styles.container} id='sobre'>
      ...
      <aside className={styles.container__right}>
        ...
        <div className={styles.container__botoes}>
          <Botao icon={<FiDownloadCloud className={styles.LogoDownload} />} text={t('Curriculo')} gradient='linear-gradient(236deg, rgba(26,35,44,1) 0%, rgba(0,215,255,1) 100%)' url="https://drive.google.com/file/d/173lO1BNQa_abjr2BS0H45bkAs0HO0YSr/view?usp=sharing" />
